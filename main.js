(function () {
    ...
    const UI_COPY = {
        ...
        "场景调节": { "zh-TW": "場景調節", "en": "Scene tuning" },
        "场景引擎调节台": { "zh-TW": "場景引擎調節台", "en": "Scene engine console" },
        "关闭场景调节": { "zh-TW": "關閉場景調節", "en": "Close scene tuning" },
        "场景调节台": { "zh-TW": "場景調節台", "en": "Scene console" },
        "数值读出": { "zh-TW": "數值讀出", "en": "Live readouts" },
        "渲染状态": { "zh-TW": "渲染狀態", "en": "Render state" },
        "着色器档位": { "zh-TW": "著色器檔位", "en": "Shader tier" },
        "体积光步数": { "zh-TW": "體積光步數", "en": "Ray steps" },
        "天气混合": { "zh-TW": "天氣混合", "en": "Weather blend" },
        "太阳仰角": { "zh-TW": "太陽仰角", "en": "Sun elevation" },
        "屏幕分辨率": { "zh-TW": "螢幕解析度", "en": "Resolution" },
        "场景控制": { "zh-TW": "場景控制", "en": "Scene controls" },
        "北京时间": { "zh-TW": "北京時間", "en": "Beijing time" },
        "光束强度": { "zh-TW": "光束強度", "en": "Beam intensity" },
        "雨滴折射": { "zh-TW": "雨滴折射", "en": "Rain refraction" },
        "自动天气": { "zh-TW": "自動天氣", "en": "Auto weather" },
        "跟随实际时间": { "zh-TW": "跟隨實際時間", "en": "Follow real time" },
        "恢复默认": { "zh-TW": "恢復預設", "en": "Reset defaults" },
        "FPS / 帧时": { "zh-TW": "FPS / 幀時", "en": "FPS / frame time" },
        "帧率自适应（手动拖动即固定）": { "zh-TW": "幀率自適應（手動拖動即固定）", "en": "Adaptive FPS (drag to pin)" },
